            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('pengaduan')}}" class="btn btn-success mb-4">Kembali</a>
                        </div>
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('pengaduan.update',$pengaduan->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control" id="tgl_pengaduan" name="tgl_pengaduan" required value="{{ $pengaduan->tgl_pengaduan }}">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div>
                                            <img src="{{ asset("foto_pengaduan/{$pengaduan->foto}") }}" alt="Current Foto" width="150">
